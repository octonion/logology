...
/* Main search routine */
  ...
  for (w1=1; w1<=word_count; ++w1)
  {
    ...
    { try[0] = word_list[w1][x];
      if (!(in_list(try, (long) 1, (long) word_count-1, 0)))
      {  failed_check = TRUE;
         break; }
      k[1][x]=m;
    }
  ...
  for (w2=b2; w2<=e2; ++w2)
  {
    ...
    { try[0] = word_list[w1][x];
      ...
      if (!(in_list(try, listing[k[1][x]][1][0], listing[k[1][x]][1][1], 1)))
      {  failed_check = TRUE;
         break; }
      k[2][x]=m;
    }
  ...
  for (w3=b3; w3<=e3; ++w3)
  {
    ...
    { try[0] = word_list[w1][x];
      ...
      if (!(in_list(try, listing[k[2][x]][1][0], listing[k[2][x]][1][1], 2)))
      {  failed_check = TRUE;
         break; }
      k[3][x]=m;
    }
  ...
  for (w4=b4; w4<=e4; ++w4)
  {
    ...
    { try[0] = word_list[w1][x];
      ...
      if (!(in_list(try, listing[k[3][x]][1][0], listing[k[3][x]][1][1], 3)))
      {  failed_check = TRUE;
         break; }
      k[4][x]=m;
    }
  ...
  for (w5=b5; w5<=e5; ++w5)
  {
    ...
    { try[0] = word_list[w1][x];
      ...
      if (!(in_list(try, listing[k[4][x]][1][0], listing[k[4][x]][1][1], 4)))
      {  failed_check = TRUE;
         break; }
      k[5][x]=m;
    }
  ...
  for (w6=b6; w6<=e6; ++w6)
  {
    ...
    { try[0] = word_list[w1][x];
      ...
      if (!(in_list(try, listing[k[5][x]][1][0], listing[k[5][x]][1][1], 5)))
      {  failed_check = TRUE;
         break; }
      k[6][x]=m;
    }
  ...
  for (w7=b7; w7<=e7; ++w7)
  {
    ...
    { try[0] = word_list[w1][x];
      ...
      if (!(in_list(try, listing[k[6][x]][1][0], listing[k[6][x]][1][1], 6)))
      {  failed_check = TRUE;
         break; }
      k[7][x]=m;
    }
  ...
  for (w8=b8; w8<=e8; ++w8)
  {
    ...
    { try[0] = word_list[w1][x];
      ...
      if (!(in_list(try, listing[k[7][x]][1][0], listing[k[7][x]][1][1], 7)))
      {  failed_check = TRUE;
         break; }
    }
