...
/* Main search routine */
  ...
  for (w5=b5; w5<=e5; ++w5)
  {
    ...
    if (!(in_list(num_list[w5][8],listing[k[4][8]][4][0],
	          listing[k[4][8]][4][1],4)));
    k[5][8]=m;
    
    if (!(in_list(num_list[w5][7],listing[k[4][7]][4][0],
	          listing[k[4][7]][4][1],4)));
    k[5][7]=m;

    if (!(in_list(num_list[w5][6],listing[k[4][6]][4][0],
	          listing[k[4][6]][4][1],4)));
    k[5][6]=m;

    if (!(in_list(num_list[w5][5],listing[k[4][5]][4][0],
	          listing[k[4][5]][4][1],4)));
    k[5][5]=m;
  ...
  for (w6=b6; w6<=e6; ++w6)
  {
    ...
    if (!(in_list(num_list[w6][8],listing[k[5][8]][5][0],
	          listing[k[5][8]][5][1],5)));
    k[6][8]=m;

    if (!(in_list(num_list[w6][7],listing[k[5][7]][5][0],
	          listing[k[5][7]][5][1],5)));
    k[6][7]=m;

    if (!(in_list(num_list[w6][6],listing[k[5][6]][5][0],
	          listing[k[5][6]][5][1],5)));
    k[6][6]=m;
  ...
  for (w7=b7; w7<=e7; ++w7)
  {
    ...
    if (!(in_list(num_list[w7][8],listing[k[6][8]][6][0],
	          listing[k[6][8]][6][1],6)));
    k[7][8]=m;
    
    if (!(in_list(num_list[w7][7],listing[k[6][7]][6][0],
	          listing[k[6][7]][6][1],6)));
    k[7][7]=m;    
  ...
  for (w8=b8; w8<=e8; ++w8)
  {
    ...
    if (!(in_list(num_list[w8][8],listing[k[7][8]][7][0],
	          listing[k[7][8]][7][1],7)));
